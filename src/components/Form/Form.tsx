    ...
    >
      <Form className="flex w-full flex-col gap-[20px] rounded-[10px] bg-gradient-to-br from-white0 to-white p-[20px] shadow-white3">
        ...
        <button type="submit" className="group">
          <span className="flex h-[55px] flex-row items-center justify-center rounded-md bg-gradient-to-br from-white0 to-white px-[15px] font-nav text-[14px] font-medium uppercase leading-[1.7em] tracking-[1px] text-text shadow-white3 transition-all duration-400 ease-in-out group-hover:translate-y-[-5px] group-hover:from-purple group-hover:to-red group-hover:text-white">
            Bericht verzenden
          </span>
        </button>
      </Form>
